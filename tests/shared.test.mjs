...
assert.equal(enabled.stereo.enabled, false);
assert.equal(enabled.stereo.width, 1);
assert.equal(enabled.stereo.balance, 0);
assert.equal(enabled.stereo.mono, false);
assert.equal(enabled.stereo.swap, false);
